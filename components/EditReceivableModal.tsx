...
const EditReceivableModal: React.FC<EditReceivableModalProps> = ({
    isOpen, onClose, record, companies, customers, banks, onSuccess, mode = 'edit'
}) => {
            ...
            <div className="bg-white dark:bg-surface-dark w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-surface-highlight animate-in fade-in zoom-in duration-200">
                <div className="p-6 border-b border-slate-200 dark:border-surface-highlight flex justify-between items-center bg-slate-50 dark:bg-surface-highlight/20">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Editar Recebimento</h2>
                    </div>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <select required value={customerId} onChange={e => setCustomerId(e.target.value)} className="w-full bg-slate-50 dark:bg-[#111813] border border-slate-200 dark:border-surface-highlight rounded-xl h-12 px-4 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary font-bold appearance-none">
                        ...
                        <div className="py-12 flex flex-col items-center text-center space-y-6 animate-in slide-in-from-bottom-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-slate-600 dark:text-text-secondary font-medium px-8">
                                    Esta ação não pode ser desfeita. O recebimento <strong className="text-slate-900 dark:text-white">"{description}"</strong> será removido permanentemente.
                                </p>
                            </div>
