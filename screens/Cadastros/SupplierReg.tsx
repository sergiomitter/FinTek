...
import { validateCNPJ, formatCNPJ, validateCPF, formatCPF, formatDocument } from '../../utils/helpers';
              ...
              {loading ? (
                ...
                filteredSuppliers.map((s) => (
                  <tr key={s.id} className="group hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-5">
                      <button
                        onClick={() => user.role === 'MASTER_ADMIN' && handleToggleActive(s.id, s.is_active)}
